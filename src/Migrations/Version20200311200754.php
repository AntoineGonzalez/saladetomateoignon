 ...
 */
final class Version20200311200754 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purshase ADD delivery_hour DATETIME DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purshase DROP delivery_hour, CHANGE user_id user_id INT DEFAULT NULL');
