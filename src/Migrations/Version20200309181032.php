 ...
 */
final class Version20200309181032 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE menu ADD description VARCHAR(1000) DEFAULT NULL, CHANGE sandwich_id sandwich_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE menu DROP description, CHANGE sandwich_id sandwich_id INT DEFAULT NULL');
