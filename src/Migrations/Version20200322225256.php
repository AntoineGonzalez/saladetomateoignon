 ...
 */
final class Version20200322225256 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purshase_products DROP ingredients, CHANGE product_id product_id INT DEFAULT NULL, CHANGE purshase_id purshase_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purshase_products ADD ingredients VARCHAR(1000) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE product_id product_id INT DEFAULT NULL, CHANGE purshase_id purshase_id INT DEFAULT NULL');
