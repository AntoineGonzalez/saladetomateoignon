 ...
 */
final class Version20200220123957 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE purshase_menu (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE purshase_menu_menu (purshase_menu_id INT NOT NULL, menu_id INT NOT NULL, INDEX IDX_7464A759630A85B1 (purshase_menu_id), INDEX IDX_7464A759CCD7E912 (menu_id), PRIMARY KEY(purshase_menu_id, menu_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE purshase_menu_purshase (purshase_menu_id INT NOT NULL, purshase_id INT NOT NULL, INDEX IDX_E8F6813A630A85B1 (purshase_menu_id), INDEX IDX_E8F6813A29348F92 (purshase_id), PRIMARY KEY(purshase_menu_id, purshase_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
