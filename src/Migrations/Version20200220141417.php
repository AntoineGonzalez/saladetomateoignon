 ...
 */
final class Version20200220141417 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE purshase_menu (purshase_id INT NOT NULL, menu_id INT NOT NULL, INDEX IDX_2A18731829348F92 (purshase_id), INDEX IDX_2A187318CCD7E912 (menu_id), PRIMARY KEY(purshase_id, menu_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
