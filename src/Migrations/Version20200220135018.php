 ...
 */
final class Version20200220135018 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE menu ADD sandwich_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE menu ADD CONSTRAINT FK_7D053A934D566043 FOREIGN KEY (sandwich_id) REFERENCES product (id)');
        $this->addSql('CREATE INDEX IDX_7D053A934D566043 ON menu (sandwich_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_7D053A934D566043 ON menu');
        $this->addSql('ALTER TABLE menu DROP sandwich_id');
        $this->addSql('ALTER TABLE product CHANGE category_id category_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE purshase CHANGE user_id user_id INT DEFAULT NULL');
