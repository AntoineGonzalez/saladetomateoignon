 ...
 */
final class Version20200321134016 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purshase ADD trust_score INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE delivery_hour delivery_hour DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purshase DROP trust_score, CHANGE user_id user_id INT DEFAULT NULL, CHANGE delivery_hour delivery_hour DATETIME DEFAULT \'NULL\'');
