 ...
 */
final class Version20200224135810 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE purshase_menus (id INT AUTO_INCREMENT NOT NULL, purshase_id INT DEFAULT NULL, formule_id INT DEFAULT NULL, INDEX IDX_8484F2E29348F92 (purshase_id), INDEX IDX_8484F2E2A68F4D1 (formule_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
