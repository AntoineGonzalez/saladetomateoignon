 ...
 */
final class Version20200220123111 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE purshased_menus (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE purshased_menus_purshase (purshased_menus_id INT NOT NULL, purshase_id INT NOT NULL, INDEX IDX_20AF752A6BF94AAF (purshased_menus_id), INDEX IDX_20AF752A29348F92 (purshase_id), PRIMARY KEY(purshased_menus_id, purshase_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
