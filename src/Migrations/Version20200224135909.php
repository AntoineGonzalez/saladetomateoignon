 ...
 */
final class Version20200224135909 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE purshase_menus_content (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE purshase_menus_content_product (purshase_menus_content_id INT NOT NULL, product_id INT NOT NULL, INDEX IDX_F0B4356EEA1F11C3 (purshase_menus_content_id), INDEX IDX_F0B4356E4584665A (product_id), PRIMARY KEY(purshase_menus_content_id, product_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
