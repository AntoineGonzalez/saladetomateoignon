 ...
 */
final class Version20200228164025 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purshase ADD customer_comment VARCHAR(1000) DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL');
