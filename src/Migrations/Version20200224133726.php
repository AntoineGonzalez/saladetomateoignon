 ...
 */
final class Version20200224133726 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE purshase_menu_product (id INT AUTO_INCREMENT NOT NULL, purchase_id INT DEFAULT NULL, formule_id INT DEFAULT NULL, product_id INT DEFAULT NULL, INDEX IDX_B128B2AB2A68F4D1 (formule_id), INDEX IDX_B128B2AB4584665A (product_id), INDEX IDX_B128B2AB558FBEB9 (purchase_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
