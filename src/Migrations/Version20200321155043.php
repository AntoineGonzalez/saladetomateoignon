 ...
 */
final class Version20200321155043 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purshase ADD paid TINYINT(1) DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE delivery_hour delivery_hour DATETIME DEFAULT NULL, CHANGE trust_score trust_score INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purshase DROP paid, CHANGE user_id user_id INT DEFAULT NULL, CHANGE delivery_hour delivery_hour DATETIME DEFAULT \'NULL\', CHANGE trust_score trust_score INT DEFAULT NULL');
