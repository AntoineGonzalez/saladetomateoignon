 ...
 */
final class Version20200304194207 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purshase_products ADD qty INT NOT NULL, CHANGE purshase_id purshase_id INT DEFAULT NULL, CHANGE product_id product_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purshase_products DROP qty, CHANGE purshase_id purshase_id INT DEFAULT NULL, CHANGE product_id product_id INT DEFAULT NULL');
