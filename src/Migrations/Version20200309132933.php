 ...
 */
final class Version20200309132933 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD discord_id VARCHAR(255) DEFAULT NULL, CHANGE roles roles JSON NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purshase_products CHANGE product_id product_id INT DEFAULT NULL, CHANGE purshase_id purshase_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE user DROP discord_id, CHANGE roles roles LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_bin`');
    }
}
