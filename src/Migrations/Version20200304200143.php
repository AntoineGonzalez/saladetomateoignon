 ...
 */
final class Version20200304200143 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purshase_products CHANGE purshase_id purshase_id INT DEFAULT NULL, CHANGE product_id product_id INT DEFAULT NULL');
