 ...
 */
final class Version20200322225248 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purshase_products CHANGE product_id product_id INT DEFAULT NULL, CHANGE purshase_id purshase_id INT DEFAULT NULL, CHANGE ingredients ingredients VARCHAR(1000) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purshase_products CHANGE product_id product_id INT DEFAULT NULL, CHANGE purshase_id purshase_id INT DEFAULT NULL, CHANGE ingredients ingredients VARCHAR(1000) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
