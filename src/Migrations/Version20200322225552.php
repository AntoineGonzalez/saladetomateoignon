 ...
 */
final class Version20200322225552 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purshase CHANGE user_id user_id INT DEFAULT NULL, CHANGE delivery_hour delivery_hour DATETIME DEFAULT NULL, CHANGE trust_score trust_score INT DEFAULT NULL, CHANGE paid paid TINYINT(1) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE purshase_menus ADD ingredients VARCHAR(1000) DEFAULT NULL, CHANGE formule_id formule_id INT DEFAULT NULL, CHANGE purshase_id purshase_id INT DEFAULT NULL, CHANGE customer_comment customer_comment VARCHAR(1000) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purshase CHANGE user_id user_id INT DEFAULT NULL, CHANGE delivery_hour delivery_hour DATETIME DEFAULT \'NULL\', CHANGE trust_score trust_score INT DEFAULT NULL, CHANGE paid paid TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE purshase_menus DROP ingredients, CHANGE purshase_id purshase_id INT DEFAULT NULL, CHANGE formule_id formule_id INT DEFAULT NULL, CHANGE customer_comment customer_comment VARCHAR(1000) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE purshase_products CHANGE product_id product_id INT DEFAULT NULL, CHANGE purshase_id purshase_id INT DEFAULT NULL');
