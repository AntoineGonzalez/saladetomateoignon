 ...
 */
final class Version20200224093754 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purshase_menu_product CHANGE purchase_id purchase_id INT DEFAULT NULL, CHANGE formule_id formule_id INT DEFAULT NULL, CHANGE product_id product_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE purshase_product (purshase_id INT NOT NULL, product_id INT NOT NULL, INDEX IDX_7C97680E29348F92 (purshase_id), INDEX IDX_7C97680E4584665A (product_id), PRIMARY KEY(purshase_id, product_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
